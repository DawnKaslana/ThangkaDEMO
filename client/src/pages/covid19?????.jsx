...
const StyledList = styled(List)({
  ...
  export function Covid19() {
      ...
      const [radioValue, setRadioValue] = useState(showKey);
      ...
      const colorA = [ 'rgb(255,255,217,0)','rgb(255,255,217)', 'rgb(237,248,177)', 'rgb(199,233,180)', 'rgb(127,205,187)', 'rgb(65,182,196)', 'rgb(29,145,192)', 'rgb(34,94,168)', 'rgb(12,44,132)' ];
    ...
    const onSceneLoaded = (scene) => {
        ...
        .then(res => {
            ...
            const grades = ['0', '1-9', '10-99', '100-499', '500-999', '1000-10000', '>10000','>20000','>30000'];
      ...
      <Box>
          ...
          <Box sx={{display: 'flex'}}>
            ...
            <LarkMap {...config} onSceneLoaded={onSceneLoaded} style={{ flexGrow:'1',height:'93%',justifyContent: 'center',position: 'relative' }}/>
