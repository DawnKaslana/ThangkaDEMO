...
(0, 'in the left middle hand', '在左中手', 6),
(0, 'gorgeous', '华丽的', 6),
(0, 'exquisite', '精致的', 6),
(0, 'simple', '简单的', 6),
(0, 'mandorla with golden line', '带金线的曼陀罗', 6),
(0, 'wavy line pattern', '波浪线图案', 6),
(0, 'wooden', '木质的', 6),
(0, 'exquisite mandorla', '精致的曼陀罗', 6),
...
(0, 'wear leaves tiara', '戴叶子王冠', 6),
(0, 'wear tiara', '戴王冠', 6),
(0, 'wear crown', '戴皇冠', 6),
(0, 'wear jewelry', '佩戴珠宝', 6),
(0, 'wear double bracelet', '佩戴双手链', 6),
(0, 'with pendant', '带吊坠', 6),
(0, 'black hair down on shoulders', '黑发披肩', 6),
(0, 'dark blue three-eyed head', '深蓝色三眼头部', 6),
(0, 'angry head', '愤怒的头部', 6),
(0, 'colorful Mandorla', '五彩的曼陀罗', 6),
(0, 'yellow background', '黄色背景', 6);

-- 花朵描述
INSERT INTO `label` (`user_id`, `value`, `zh_CN`, `class`) VALUES
(0, 'bud type', '花苞型', 7),
(0, 'cloud shaped petals', '云形花瓣', 7),
(0, 'flat type', '平面型', 7),
(0, 'flore pleno type', '重瓣型', 7),
(0, 'jagged petals', '锯齿花瓣', 7),
(0, 'long peduncle', '长花梗', 7),
(0, 'one layer type', '单层型', 7),
(0, 'petals closed', '花瓣闭合', 7),
(0, 'pointed petals', '尖瓣', 7),
